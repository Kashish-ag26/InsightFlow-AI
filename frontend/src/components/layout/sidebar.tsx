...
export function Sidebar() {
  ...
  return (
    <aside className="w-[200px] flex flex-col h-screen bg-[#fbfaf8] dark:bg-[#1c1b18] text-[#2c2c2a] dark:text-[#fbfaf8] select-none shrink-0 p-3">
      {/* Notion AI Logo Header */}
      <Link href="/dashboard" className="flex items-center gap-2 px-2 py-2 mb-4 hover:opacity-90">
      ...
      <div className="pt-3 border-t border-[#ece9e3] dark:border-zinc-800 px-2 flex items-center justify-between text-xs text-[#8a8880]">
        ...
        <Link href="/login" className="hover:underline text-[10px]">
          Logout
        </Link>
      </div>
    </aside>
